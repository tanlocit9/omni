...
| Contracts           | The [`contracts`](../../libs/contracts) Nx project owns versioned common/job Proto3 schemas, pinned local generation, committed Java/Python output, and CI checks; production wire formats remain unchanged.                                                                | P2-I1 is completed; P2-I2 remains pending until P1-I4 is completed.                                  |
...
The next increment daily automation should select is P3-I1 from [`implementation-increments.md`](implementation-increments.md). P2-I1 has completed implementation and successful CI evidence in draft PR #9; P2-I2 remains dependency-incomplete because P1-I4 is not completed.
