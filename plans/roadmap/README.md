...
| 8 — Notification routing         | P1-I4; P8-I5 depends on completed P8-I1, P8-I2, and P9-I5                                                    | Modern Telegram formats, signal presentation, routing, and durable outbox delivery.                                             |
| 9 — Intraday EOD                 | Phases 2, 3, and 5; active P9-I5 follows P9-I1                                                               | Bounded VCI completed-session ingestion plus health metrics before later capacity assessment.                                   |
...
The active MVP is the existing daily/EOD pipeline plus usable Telegram operational and signal notifications and basic Phase 7 operator controls. P1-I3, P8-I1, and P8-I2 may finish evidence reconciliation. P8-I4 and P9-I4 remain active bounded signal work. P4-I3 is admitted as critical scheduler correctness work with completed prerequisites but remains pending while active work overlaps `apps/core`. After P9-I1 completes, P9-I5 adds simple VCI health metrics using an existing health/dashboard surface; P8-I5 then adds Notification Outbox durable delivery through its explicit P9-I5 dependency. Phase 11 starts only after completed P4-I3 and P8-I5, then executes P11-I1 through P11-I5 sequentially. Capacity assessment follows P8-I5 as deferred work, and multi-provider remains separately deferred. These increments do not authorize WebSocket/Kafka/live market-data collection, provider fallback, or rate-limit-bypass concurrency.
...
P4-I3 remains pending despite completed prerequisites because active `apps/core` work conflicts with its ownership; promote it only through normal readiness propagation after those conflicts are reconciled. P8-I1 and P8-I2 remain notification evidence gates; P8-I4 and P9-I4 remain active. P9-I1 remains verification-pending, so P9-I5 and P8-I5 are pending. Once eligible, execute P9-I5 first and P8-I5 second; P8-I5 declares `depends_on: [P8-I1, P8-I2, P9-I5]`, and P9-I5 explicitly blocks P8-I5. After both P4-I3 and P8-I5 complete, execute P11-I1, P11-I2, P11-I3, P11-I4, and P11-I5 in that exact order. VCI capacity assessment remains deferred after P8-I5, and multi-provider remains deferred pending separate owner approval. P10-I0/P10-I3 remain `blocked`; P9-I5 does not provide realtime evidence or unblock them. P10-I1/P10-I2 remain `verification_pending`; P2-I3, P9-I2, and P9-I3 remain `superseded`.
