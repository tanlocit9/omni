...
| 2026-08-14 | P2-I1                      | completed | `codex/p2-i1-proto-contracts`  | [PR #9](https://github.com/tanlocit9/omni/pull/9) | 959c81ed77a8393bf9d1d10a6552a037a31dcfef | [CI success](https://github.com/tanlocit9/omni/actions/runs/31729904534); Buf format/lint/build/breaking/generate-check and generated artifact checks | Added common/job v1 schemas and deterministic Java/Python output without changing production wire formats. Used pinned local protoc generation so schemas are not uploaded to remote plugins. No dependent was promoted: P2-I2 still requires P1-I4, while P8-I1 and P9-I1 have additional incomplete dependencies. P3-I1 is next. |
