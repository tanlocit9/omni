...
| Web app             | [`apps/omni-console`](../../apps/omni-console) and [`apps/query-service`](../../apps/query-service) are the focused V1 implementation paths.                                                                                                                                | Use server-side native DuckDB over logical READY dataset references; never expose credentials or physical object paths to the browser. |
