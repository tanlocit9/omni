...
- [Job Dependency Guard Implementation Plan](005-job-dependency-guard.md) - High-level goals and outcomes
- [Dataset Metadata Manifest](003-dataset-metadata-manifest.md) - Prerequisite manifest infrastructure
- [Dataset Manifest Rule](../../AGENTS.md#dataset-manifest-rule) - Repository guidance
- [Data Lake Documentation](../data/002-data-lake.md) - Manifest schema and semantics
