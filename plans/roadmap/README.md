...
| Contracts           | The [`contracts`](../../contracts) Nx project owns versioned common/job Proto3 schemas, pinned local generation, committed Java/Python output, and CI checks; production wire formats remain unchanged.                                                                     | P2-I1 is completed; P2-I2 remains pending until P1-I4 is completed.                                  |
