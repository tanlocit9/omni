...
| plans/022 | [Dependency-Aware Outbox Dispatch](plans/022-dependency-aware-outbox-dispatch.md)                              | Draft implementation plan         | Groups A-B; dispatch follow-up     |
...
| Group A - Control-plane safety             | `data/003`; `flows/001`; `deployment/001`; `plans/001`, `plans/022`                                                          |
| Group B - Deterministic contracts and data | `data/001-003`; `plans/002-004`, `plans/022`; `technical-debt/001`                                                           |
