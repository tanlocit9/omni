...
- Phase detail files: [`phase-0-immediate-correctness.md`](phase-0-immediate-correctness.md) through [`phase-11-cross-service-observability.md`](phase-11-cross-service-observability.md).
