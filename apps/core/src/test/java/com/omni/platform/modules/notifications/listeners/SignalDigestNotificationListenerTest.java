...
class SignalDigestNotificationListenerTest {
    ...
    void onSignalDigestNotificationRendersAndSendsSignalNotificationOnce() {
        ...
        var listener = new SignalDigestNotificationListener(notificationService, signalNotificationTemplate);
    ...
    void onSignalDigestNotificationIsAsyncTransactionalAfterCommitListener() throws NoSuchMethodException {
        Method method = SignalDigestNotificationListener.class.getDeclaredMethod(
