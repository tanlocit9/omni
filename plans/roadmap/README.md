...
| [`docs/plans/010-dataset-component-market-dashboard.md`](../../docs/plans/010-dataset-component-market-dashboard.md)                 | Proposed Phase 6 product increment | Not roadmap-scheduled; reconcile with Phase 6 and the focused Console plan before selection |
