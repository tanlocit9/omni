...
| status                  | pending                                         |
| priority                | high                                            |
| depends_on              | [P2-I3, P3-I3, P4-I2, P5-I2]                    |
| blocks                  | [P6-I2, P6-I3]                                  |
...
Goal: define read-only Platform APIs and private-access controls before UI scaffolding.

Acceptance criteria: catalog/manifest/access resolver APIs are documented and tested, browser receives no object-store credentials, resolver returns short-lived allow-listed URLs only for authorized logical dataset/version references, and Internet-facing deployment requires identity-aware protection.
...
Stop conditions: owner must approve V1 access boundary, private network assumption, and presigned URL strategy.
...
Goal: rename [`docs/INTERNAL_TOOLS_PARQUET_VIEWER_IMPLEMENTATION_PLAN.md`](../../docs/INTERNAL_TOOLS_PARQUET_VIEWER_IMPLEMENTATION_PLAN.md) to the Omni Console Dataset Explorer plan and scaffold the Nx React/Vite application.
