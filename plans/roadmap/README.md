...
| 8 — Notification routing       | P1-I4; P8-I5 depends on P8-I1/P8-I2 and has an explicit selection gate requiring completed P9-I5             | Modern Telegram formats, signal presentation, routing, and durable outbox delivery.                                     |
...
The active MVP is the existing daily/EOD pipeline plus usable Telegram operational and signal notifications and basic Phase 7 operator controls. P1-I3, P8-I1, and P8-I2 may finish evidence reconciliation. P8-I4 and P9-I4 remain active bounded signal work. After P9-I1 completes, P9-I5 adds simple VCI health metrics using an existing health/dashboard surface; P8-I5 then adds Notification Outbox durable delivery under the explicit selection gate. Capacity assessment follows those increments as deferred work, and multi-provider remains separately deferred. Neither increment authorizes WebSocket/Kafka/live collection, provider fallback, or rate-limit-bypass concurrency.
...
| [`docs/plans/015-cross-service-observability-correlation.md`](../../docs/plans/015-cross-service-observability-correlation.md)               | Deferred technical debt           | Not roadmap-scheduled; assign dependencies/increment IDs before selection             |
...
| [`docs/plans/022-notification-outbox.md`](../../docs/plans/022-notification-outbox.md)                                                       | Active P8-I5 supporting detail    | Canonical registry owns status, dependencies, selection gate, and execution order     |
...
P8-I1 and P8-I2 remain notification evidence gates; P8-I4 and P9-I4 remain active. P9-I1 remains verification-pending, so P9-I5 and P8-I5 are pending. Once eligible, execute P9-I5 first and P8-I5 second; P8-I5 retains depends_on `[P8-I1, P8-I2]`, with the P9-I5 ordering enforced by the explicit selection gate rather than a dependency edge. VCI capacity assessment remains deferred after P8-I5, and multi-provider remains deferred pending separate owner approval. P10-I0/P10-I3 remain `blocked`; P9-I5 does not provide realtime evidence or unblock them. P10-I1/P10-I2 remain `verification_pending`; P2-I3, P9-I2, and P9-I3 remain `superseded`.
