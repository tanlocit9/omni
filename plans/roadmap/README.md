...
| [`docs/plans/014-realtime-per-tick.md`](../../docs/plans/014-realtime-per-tick.md)                                                           | Deferred technical debt           | Phase 10 increments                                                                  |
...
P8-I1 and P8-I2 are the active notification evidence gates, followed by P8-I4 `CONFIRMED_TREND_EQUALS`; P1-I3 may also finish reconciliation for the daily/EOD pipeline. P9-I1 remains verification-pending for bounded VCI normalized trades, and P9-I4 is in progress for exact-date intraday confirmation/suppression. P8-I3, P9-I2, P9-I3, and all unfinished Proto3 migration, advanced manifest/metadata, portable-deployment hardening, broad Console/query polish, and realtime increments remain `superseded`. The generalized weighted combination/versioning platform is documented post-MVP in [`docs/technical-debt/004-post-mvp-roadmap-work.md`](../../docs/technical-debt/004-post-mvp-roadmap-work.md). Automation must not expand P8-I4, P9-I1, or P9-I4 beyond their approved boundaries without a new owner decision.
