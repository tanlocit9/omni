...
Last source cross-check: `main@bd377c3022fa4561e28fd70d84754ff59a3781eb` plus draft PR #16 head `ab2cc3cb0044c87d2b61a6736652c6fd4cfb2124`. P3-I4 has exact-head successful CI and is completed but unmerged. P1-I3 is committed and CI-verified on that shared PR but remains verification-pending because increment-specific PR evidence is absent.
