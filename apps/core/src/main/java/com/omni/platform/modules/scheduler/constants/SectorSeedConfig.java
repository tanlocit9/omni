...
public final class SectorSeedConfig {
        ...
        public static final List<SectorSeed> SECTOR_SEEDS = List.of(
                        ...
                        new SectorSeed("SECURITIES", "Dịch vụ tài chính", "Financial Services", DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL,
                                        "8770"),
                        new SectorSeed("REAL_ESTATE", "Bất động sản", "Real Estate", DEFAULT_TAXONOMY, DEFAULT_LEVEL,
                                        "8630"),
                        new SectorSeed("INSURANCE", "Bảo hiểm", "Insurance", DEFAULT_TAXONOMY, DEFAULT_LEVEL, "8530"),
                        new SectorSeed("BASIC_RESOURCES", "Tài nguyên cơ bản", "Basic Resources", DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL,
                                        "1750"),
                        ...
                        new SectorSeed("AUTOMOBILES_PARTS", "Ô tô và Phụ tùng", "Automobiles and Parts",
                                        DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL, "3350"),
                        new SectorSeed("FOOD_BEVERAGE", "Thực phẩm và Đồ uống", "Food and Beverage", DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL, "3570"),
                        new SectorSeed("PERSONAL_HOUSEHOLD_GOODS", "Hàng cá nhân và Gia dụng",
                        ...
                        new SectorSeed("TRAVEL_LEISURE", "Du lịch và Giải trí", "Travel and Leisure", DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL, "5750"),
                        new SectorSeed("TELECOMMUNICATIONS", "Viễn thông", "Telecommunications", DEFAULT_TAXONOMY,
                                        DEFAULT_LEVEL,
                                        "6530"),
                        new SectorSeed("UTILITIES", "Tiện ích", "Utilities", DEFAULT_TAXONOMY, DEFAULT_LEVEL, "7570"),
                        new SectorSeed("TECHNOLOGY", "Công nghệ", "Technology", DEFAULT_TAXONOMY, DEFAULT_LEVEL,
                                        "9530"));
