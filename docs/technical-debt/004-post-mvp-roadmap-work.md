...
| Realtime per tick               | P10-I0, P10-I3             | Owner retained the locally verified P10-I1 strict contract and P10-I2 finite archive/rebuild foundations, then moved provider capability discovery and provider adapter/Kafka/WebSocket/live runtime here. Both increments are `superseded`, approval-gated technical debt and are not active blockers for P10-I1/P10-I2 evidence reconciliation. |
...
| [`docs/plans/014-realtime-per-tick.md`](../plans/014-realtime-per-tick.md)                                                           | Bounded foundation plus deferred runtime | P10-I1/P10-I2 retain source and local evidence; P10-I0/P10-I3 are technical debt requiring provider access, refreshed objective criteria, and explicit owner reactivation. |
