...
| 10 — Realtime per tick         | P10-I1 strict contract precedes P10-I2 finite archive/rebuild; provider/live scope is deferred technical debt          | Locally verified tick/archive/rebuild foundations pending delivery evidence; provider Kafka/WebSocket/live semantics are superseded. |
...
The active MVP is the existing daily/EOD pipeline plus usable Telegram operational and signal notifications and basic Phase 7 operator controls. P1-I3, P8-I1, and P8-I2 may finish evidence reconciliation because they directly support that boundary. P8-I4 adds the bounded `CONFIRMED_TREND_EQUALS` signal, P9-I1 adds VCI normalized trades for configured HOSE/HNX/UPCOM exchanges, and owner-authorized P9-I4 uses exact-date intraday evidence to confirm or suppress the daily candidate without reactivating later bars/features or realtime work.
...
| [`docs/plans/011-telegram-notification-format-modernization.md`](../../docs/plans/011-telegram-notification-format-modernization.md)         | Scheduled/deferred Phase 8 detail  | P8-I1 operational/generic formats, P8-I2 signal formats; P8-I3 is technical debt     |
...
| [`docs/plans/014-realtime-per-tick.md`](../../docs/plans/014-realtime-per-tick.md)                                                           | Bounded Phase 10 foundation record | P10-I1/P10-I2 evidence; P10-I0/P10-I3 provider/live scope is deferred technical debt |
...
P8-I1 and P8-I2 are the active notification evidence gates, followed by P8-I4 `CONFIRMED_TREND_EQUALS`; P1-I3 may also finish reconciliation for the daily/EOD pipeline. P9-I1 remains verification-pending and P9-I4 remains in progress. Phase 10 provider-independent P10-I1/P10-I2 source and local checks are complete, with both increments `verification_pending` for delivery evidence. P10-I0 provider discovery and P10-I3 provider/Kafka/WebSocket/live runtime are `superseded` technical debt and ineligible for automation. P2-I3, P9-I2, and P9-I3 remain `superseded`; Phase 9 is not complete. All other deferred scope remains unchanged.
